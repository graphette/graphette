...
use Graphette\Graphette\Scalar\Value\Decimal;
...
class DecimalType extends ScalarType {
    ...
    public ?string $description = 'The `Decimal` scalar type represents a valid decimal passed as a string (preventing float round errors).';
     ...
     */
    public function parseValue($value): Decimal {
		return Decimal::createFromString($value);
    }
